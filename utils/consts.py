...
COLUMNS = ["Name (E)", "YY/MM", "BOD(㎎/L)", "COD(㎎/L)", "Conductivity(µS/㎝)","DO (㎎/L)"
           , "Dissolved Total P(㎎/L)", "SS(㎎/L)", "T-N(㎎/L)", "T-P(㎎/L)",
           "Temp.(℃)", "TSI(Chl-a)"]
...
CHEMICAL_SUBSTANCE_COLUMNS = sorted(list(set(COLUMNS) - {LOCATION_COLUMN_NAME, TIME_COLUMN_NAME, TARGET_COLUMN_NAME}))
